...
public class ItemClickSupport {
    ...
    public static ItemClickSupport removefrom(RecyclerView recyclerView2){
        ItemClickSupport iSup = (ItemClickSupport)recyclerView2.getTag(R.id.item_click_support);
        if (iSup !=null){
            iSup.detach(recyclerView2);
        }
        return iSup;
    }
    ...
    public interface OnItemLongClickListener {
        boolean onItemLongClicked(RecyclerView recyclerView1, int position, View v);
